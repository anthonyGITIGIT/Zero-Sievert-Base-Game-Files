function SnapBufferWriteJSON(arg0, arg1, arg2 = false, arg3 = false, arg4 = false)
{
    return __SnapToJSONBufferValue(arg0, arg1, arg2, arg3, arg4, "");
}

function __SnapToJSONBufferValue(arg0, arg1, arg2, arg3, arg4, arg5)
{
    ...
    else if (is_array(arg1))
    {
        ...
        else if (arg2)
        {
            ...
            repeat (_count)
            {
                ...
                __SnapToJSONBufferValue(arg0, _array[_i], arg2, arg3, arg4, arg5);
    ...
    else if (is_struct(arg1))
    {
        ...
        else if (arg2)
        {
            ...
            repeat (_count)
            {
                ...
                buffer_write(arg0, buffer_u32, 540680226);
                __SnapToJSONBufferValue(arg0, variable_struct_get(_struct, _name), arg2, arg3, arg4, arg5);
                buffer_write(arg0, buffer_u16, 2604);
                _i++;
            }
        ...
        else
        {
            ...
            repeat (_count)
            {
                ...
                buffer_write(arg0, buffer_u8, 34);
                buffer_write(arg0, buffer_text, string(_name));
                buffer_write(arg0, buffer_u16, 14882);
                __SnapToJSONBufferValue(arg0, variable_struct_get(_struct, _name), arg2, arg3, arg4, arg5);
                buffer_write(arg0, buffer_u8, 44);
                _i++;
            }
