function item_armor_get_s_idle(arg0)
{
    ...
    if (is_string(_struct.s_idle))
        return variable_struct_get(global.Mods_Sprite_Armor_Data, _struct.s_idle);
    else
        return _struct.s_idle;
}
