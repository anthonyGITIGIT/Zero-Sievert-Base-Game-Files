function item_mod_get_scope_extend_view(arg0)
{
    if (!item_exists(arg0))
        return false;
    ...
    var _value = struct_get_from_hash(_struct, variable_get_hash("scope_extend_view"));
    
    if (_value == undefined)
        trace_error("Item \"", arg0, "\" has no .scope_extend_view data");
