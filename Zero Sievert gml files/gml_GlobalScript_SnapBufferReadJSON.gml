function SnapBufferReadJSON(arg0, arg1 = undefined)
{
    var _oldOffset;
    ...
    while (buffer_tell(arg0) < _bufferSize)
    {
        ...
        else if (_inString)
        {
            if (_byte == 34)
            {
                ...
                if (_stringUsesCache)
                {
                    ...
                    var _size = buffer_tell(arg0) - _readStart - 1;
        ...
        else if (_inValue)
        {
            ...
            {
                var _old_value = buffer_peek(arg0, buffer_tell(arg0) - 1, buffer_u8);
                buffer_poke(arg0, buffer_tell(arg0) - 1, buffer_u8, 0);
                buffer_seek(arg0, buffer_seek_start, _readStart);
                var _value = buffer_read(arg0, buffer_string);
                buffer_poke(arg0, buffer_tell(arg0) - 1, buffer_u8, _old_value);
