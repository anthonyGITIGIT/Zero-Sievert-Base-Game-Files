...
repeat (o.place_amount[ano_id])
{
    ...
    var _obj = instance_create_depth(x + xx, y + yy, -y, obj_anomaly_fire);
    _obj.need_to_check = false;
}

repeat (o.place_crystal_amount[ano_id])
{
    var xx = (irandom_range(-radius, radius) * 16) / 2;
    var yy = (irandom_range(-radius, radius) * 16) / 2;
    instance_create_depth(x + xx, y + yy, -y, obj_chest_cristallo_red);
}
