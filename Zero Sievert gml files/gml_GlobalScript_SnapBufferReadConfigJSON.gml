function SnapBufferReadConfigJSON(arg0, arg1 = undefined)
{
    var _oldOffset;
    ...
    while (buffer_tell(arg0) < _bufferSize)
    {
        ...
        if (_byte == 47 && buffer_peek(arg0, buffer_tell(arg0), buffer_u8) == 47)
            __SnapBufferReadConfigJSONComment(arg0, _bufferSize);
        else if (_byte == 47 && buffer_peek(arg0, buffer_tell(arg0), buffer_u8) == 42)
            __SnapBufferReadConfigJSONMultilineComment(arg0, _bufferSize);
        else if (_byte == 91)
            _result = __SnapBufferReadConfigJSONArray(arg0, _bufferSize);
        else if (_byte == 123)
            _result = __SnapBufferReadConfigJSONStruct(arg0, _bufferSize);
        else if (_byte > 32)
...
function __SnapBufferReadConfigJSONArray(arg0, arg1)
{
    var _result = [];
    ...
    while (buffer_tell(arg0) < arg1)
    {
        ...
        if (_byte == 47 && buffer_peek(arg0, buffer_tell(arg0), buffer_u8) == 47)
        {
            __SnapBufferReadConfigJSONComment(arg0, arg1);
        }
        else if (_byte == 47 && buffer_peek(arg0, buffer_tell(arg0), buffer_u8) == 42)
        {
            __SnapBufferReadConfigJSONMultilineComment(arg0, arg1);
        }
        else if (_byte == 93)
        {
            return _result;
        ...
        {
            var _value = __SnapBufferReadConfigJSONValue(arg0, arg1, _byte);
...
function __SnapBufferReadConfigJSONStruct(arg0, arg1)
{
    var _result = {};
    ...
    while (buffer_tell(arg0) < arg1)
    {
        ...
        {
            var _key = __SnapBufferReadConfigJSONValue(arg0, arg1, _byte);
...
function __SnapBufferReadConfigJSONStructMerge(arg0, arg1, arg2)
{
    if (variable_struct_exists(arg0, arg1))
    {
        var _oldValue = variable_struct_get(arg0, arg1);
        ...
        else if (is_struct(_oldValue))
        {
            if (is_struct(arg2))
            {
                var _variableNameArray = variable_struct_get_names(arg2);
                var _i = 0;
                
                repeat (array_length(_variableNameArray))
                {
                    var _variableName = _variableNameArray[_i];
                    __SnapBufferReadConfigJSONStructMerge(_oldValue, _variableName, variable_struct_get(arg2, _variableName));
                    _i++;
                }
    ...
    variable_struct_set(arg0, arg1, arg2);
}

function __SnapBufferReadConfigJSONValue(arg0, arg1, arg2)
{
    if (arg2 == 91)
        return __SnapBufferReadConfigJSONArray(arg0, arg1);
    else if (arg2 == 123)
        return __SnapBufferReadConfigJSONStruct(arg0, arg1);
    else if (arg2 == 34)
        return __SnapBufferReadConfigJSONDelimitedString(arg0, arg1);
    else
        return __SnapBufferReadConfigJSONString(arg0, arg1);
}

function __SnapBufferReadConfigJSONDelimitedString(arg0, arg1)
{
...
function __SnapBufferReadConfigJSONString(arg0, arg1)
{
    static _cacheBuffer = buffer_create(1024, buffer_grow, 1);
...
function __SnapBufferReadConfigJSONComment(arg0, arg1)
{
    while (buffer_tell(arg0) < arg1)
    {
        var _byte = buffer_read(arg0, buffer_u8);
...
function __SnapBufferReadConfigJSONMultilineComment(arg0, arg1)
{
    while (buffer_tell(arg0) < arg1)
    {
        var _byte = buffer_read(arg0, buffer_u8);
...
function __SnapBufferReadConfigJSONDeepCopyInner(arg0, arg1, arg2)
{
    var _copy = arg0;
    ...
    else if (is_struct(arg0))
    {
        ...
        repeat (array_length(_namesArray))
        {
            ...
            variable_struct_set(_copy, _name, __SnapBufferReadConfigJSONDeepCopyInner(variable_struct_get(arg0, _name), arg0, _copy));
            _i++;
        }
    }
    else if (is_array(arg0))
    {
        ...
        repeat (_count)
        {
            _copy[_i] = __SnapBufferReadConfigJSONDeepCopyInner(arg0[_i], arg1, arg2);
            _i++;
        }
    }
