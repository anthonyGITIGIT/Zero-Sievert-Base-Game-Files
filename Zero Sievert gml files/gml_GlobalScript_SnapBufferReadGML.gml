function SnapBufferReadGML(arg0, arg1, arg2)
{
    var _oldOffset = buffer_tell(arg0);
    buffer_seek(arg0, buffer_seek_start, arg1);
    var _parser = new __SnapBufferReadGMLParser(arg0, arg2);
    buffer_seek(arg0, buffer_seek_start, _oldOffset);
    return _parser.root;
}

function __SnapBufferReadGMLParser(arg0, arg1) constructor
{
            ...
            if (is_string(token))
            {
                ...
                else if (_state == 2)
                {
                    if (token_is_symbol)
                    {
                        if (token == "{")
                        {
                            variable_struct_set(root, _key, read_struct());
                            _state = 0;
                        }
                        else if (token == "[")
                        {
                            variable_struct_set(root, _key, read_array());
                            _state = 0;
                        }
                        else
                        {
                    ...
                    else
                    {
                        ...
                        variable_struct_set(root, _key, token);
                        _state = 0;
                    }
                }
            }
            ...
            if (is_string(token))
            {
                ...
                else if (_state == 2)
                {
                    if (token_is_symbol)
                    {
                        if (token == "{")
                        {
                            variable_struct_set(_struct, _key, read_struct());
                            _state = 0;
                        }
                        else if (token == "[")
                        {
                            variable_struct_set(_struct, _key, read_array());
                            _state = 0;
                        }
                        else if (token_is_symbol && token == "}")
                        {
                    ...
                    else
                    {
                        ...
                        variable_struct_set(_struct, _key, token);
                        _state = 0;
                    }
                }
            }
    ...
    static read_token = function()
    {
        ...
        while (buffer_tell(buffer) < buffer_size)
        {
            ...
            if (_in_string)
            {
                ...
                {
                    buffer_poke(buffer, buffer_tell(buffer) - 1, buffer_u8, 0);
                    buffer_seek(buffer, buffer_seek_start, _token_start + 1);
            ...
            else if (_token_start == undefined)
            {
                if (_value > 32)
                {
                    ...
                    else
                    {
                        ...
                        if (_value == 44 || _value == 58 || _value == 59 || _value == 61 || _value == 91 || _value == 93 || _value == 123 || _value == 125)
                        {
                            token = chr(_value);
                            token_is_string = false;
            ...
            else if (_value <= 32 || _value == 44 || _value == 58 || _value == 59 || _value == 61 || _value == 91 || _value == 93 || _value == 123 || _value == 125)
            {
                buffer_poke(buffer, buffer_tell(buffer) - 1, buffer_u8, 0);
    ...
    static try_to_find_asset_index = function(arg0)
    {
        ...
        var _index = asset_get_index(arg0);
        
        if (_index >= 0)
            return _index;
        
        if (!variable_struct_exists(_constantStruct, arg0))
            return -1;
        
        return variable_struct_get(_constantStruct, arg0);
    };
